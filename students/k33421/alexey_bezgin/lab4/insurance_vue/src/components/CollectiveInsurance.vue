<template>
<h2>Происшествия по коллективным страховым случаям</h2>
<div class="card" style="width: 18rem;">
  ...
  <ul class="list-group list-group-flush">
  	<tr v-for="item in items" :key="item.id">
  		<li class="list-group-item"><strong>Идентификатор соглашения:</strong> {{ item.agreement }}</li>
...
export default {
 data() {
  ...
  created() {
    ...
    axios.get('http://127.0.0.1:8000/col-ins/' + firstSegment)
      .then(response => {
