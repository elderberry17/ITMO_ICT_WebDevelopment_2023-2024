<template>
<h2>Коллективные страховые соглашения</h2>
...
<div class="btn-group" role="group" aria-label="Basic outlined example">
  <button @click="gotoIndivAgr()" class="btn btn-outline-secondary">К индивидуальным соглашениям</button>
...
export default {
  ...
  created() {
    axios.get('http://127.0.0.1:8000/col-agr/')
      .then(response => {
  ...
  methods : {
    gotoClaim(itemid){
      this.$router.push({ path: '/collective-agreement/' + itemid});
    },
    gotoAgents(){
